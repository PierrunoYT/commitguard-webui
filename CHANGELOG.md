...
- OpenRouter app attribution headers (`HTTP-Referer`, `X-Title`) for rankings on openrouter.ai

### Changed

- Extended error handling for 402 (insufficient credits), 408 (timeout), 502 (bad gateway)
- README: Added "Insufficient credits" to Troubleshooting table
